    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Learn how DocuAI processes your documents and get support</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Processing Workflow</h2>
            ...
            <div className="bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-lg p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Supported File Types</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-blue-900 dark:text-blue-100 mb-4">Need More Help?</h2>
              <p className="text-blue-800 dark:text-blue-200 mb-4">Our support team is here to help you get the most out of DocuAI.</p>
